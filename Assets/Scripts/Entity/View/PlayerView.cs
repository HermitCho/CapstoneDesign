...
{
    [Header("플레이어 시야 각도 설정")]
    [SerializeField]
    [Range(0f,360f)]
    public float viewAngle = 130f; // 플레이어가 볼 수 있는 시야 각도

    [Space(20)]

    // 시야 영역의 반지름과 시야 각도
    [Header("플레이어 시야 영역의 반지름 설정")]
    [SerializeField]
    [Range(0, 999)]
    ...
    void FindVisibleTargets()
    {
        ...
        foreach(var targets in targetsInViewRadius)
        {
            Transform target = targets.GetComponent<Transform>();
