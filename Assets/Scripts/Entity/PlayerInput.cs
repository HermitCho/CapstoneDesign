...
public class PlayerInput : MonoBehaviour
{
    ...
    [HideInInspector] public string skill_1_ButtonName = "Skill 1";//1번 스킬 입력 버튼 이름 
    [HideInInspector] public string skill_2_ButtonName = "Skill 2";//2번 스킬 입력 버튼 이름 
       // [HideInInspector] public string skill_3_ButtonName = "Skill 3";//3번 스킬 입력 버튼 이름
